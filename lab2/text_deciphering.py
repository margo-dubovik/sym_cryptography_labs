...
ru_freqs = {'а': 0.08413309204466018, 'б': 0.018444537359456968, 'в': 0.040462673208464264, 'г': 0.01711178764854606,
            ...
            'ф': 0.0015924399119339897, 'х': 0.009015659809103203, 'ц': 0.0038561544944370764,
            'ч': 0.015486682302521117,
            'ш': 0.008515878667511613, 'щ': 0.002889257645344849, 'ъ': 0.00022865803863667545,
            'ы': 0.019801786145936095,
            'ь': 0.018248544754911247, 'э': 0.0031946794540952655, 'ю': 0.00484755041909752, 'я': 0.023942129916964466}

ru_dict = {'а': 0, 'б': 1, 'в': 2, 'г': 3, 'д': 4, 'е': 5, 'ж': 6, 'з': 7, 'и': 8, 'й': 9, 'к': 10, 'л': 11, 'м': 12,
           'н': 13,
           'о': 14, 'п': 15, 'р': 16, 'с': 17, 'т': 18, 'у': 19, 'ф': 20, 'х': 21, 'ц': 22, 'ч': 23, 'ш': 24, 'щ': 25,
           'ъ': 26,
           'ы': 27, 'ь': 28, 'э': 29, 'ю': 30, 'я': 31}

##### var 7 #####
f = open(r'var7.txt', 'r', encoding='utf8', errors='ignore')
text = f.read()
f.close()
...
key1_numbers_1 = find_key_letter(most_freq)  # key letters`numbers
print("key 1:\n", key1_numbers_1)

key1_word_1 = num_to_letter(key1_numbers_1)
print(key1_word_1)

### визначення символів ключа за допомогою функції М_і(g)

key1_numbers_2 = find_key()  # key letters`numbers
print("key 2:\n", key1_numbers_2)

key1_word_2 = num_to_letter(key1_numbers_2)
print(key1_word_2)

key1 = key1_numbers_2

X1_numbers = decipher(text, key1)
X1 = ''.join(num_to_letter(X1_numbers))  # original text

print("KEY:", ''.join(key1_word_2))
print("ORIGINAL TEXT:\n", X1)

##### var 11 #####
f1 = open(r'var11.txt', 'r', encoding='utf8', errors='ignore')
text1 = f1.read()
f1.close()
...
key2_numbers_1 = find_key_letter(most_freq) #key letters`numbers
print("key 1:\n", key2_numbers_1)

key2_word_1 = num_to_letter(key2_numbers_1)
print(key2_word_1)


### визначення символів ключа за допомогою функції М_і(g)

key2_numbers_2 = find_key() #key letters`numbers
print("key 2:\n", key2_numbers_2)

key2_word_2 = num_to_letter(key2_numbers_2)
print(key2_word_2)
key2 = key2_numbers_2

X2_numbers = decipher(text1, key2)
X2 = ''.join(num_to_letter(X2_numbers)) #original text

print("KEY:", ''.join(key2_word_2))
print("ORIGINAL TEXT:\n", X2)